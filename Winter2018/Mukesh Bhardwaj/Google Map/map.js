...
function addResult(result, i) {
    ...
    // //var telephone =document.createTextNode( JSON.stringify(result.geometry.location));
    // //  var telephone = JSON.stringify(result.geometry.location);
    // //  telephone = document.createTextNode(JSON.parse(telephone).lat);
    //
    // //
    // // var temp=[];
    // // temp=result.photos;
    // //
    // // var t1=temp[0];
    // // t1=JSON.stringify(t1.html_attributions.toString());
    // //  t2=JSON.parse(t1.toString());
    // //  t3 = t2.toString();
    // //console.log(t1);
    //
    // //var website = document.createTextNode(temp);
    //
    // var website = document.createTextNode(result.types);
    //
